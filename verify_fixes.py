...
def main():
    ...
    try:
        sys.path.insert(0, str(Path("desktop_app")))
    ...
    try:
        ...
        with open("desktop_app/ui/main_window.py", 'r', encoding='utf-8') as f:
            content = f.read()
    ...
    try:
        with open("desktop_app/camera_manager.py", 'r', encoding='utf-8') as f:
            content = f.read()
